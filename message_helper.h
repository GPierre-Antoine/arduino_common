...
namespace pag
{
    namespace message
    {
        ...
        public:
            ...
            message_helper& edit (message_helper&) const;

        };

        template <typename iter_t>
        message_helper& bridge<iter_t>::edit(message_helper & str) const
        {
        ...
        template <typename iter_t>
        message_helper &message_helper::operator<<(const pag::message::bridge<iter_t> &stru)
        {
            return stru.edit(*this);
        }
